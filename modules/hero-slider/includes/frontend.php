<div class="relative flexbelt-module">
		...
		?>
			...
			<div class="flex flex-col justify-center h-64 bg-center bg-cover md:h-128" style="background-image: url(<?php echo $image_attributes; ?>);">
				<div class="w-full max-w-screen-xl px-8 mx-auto">
					...
					<a href="#" class="inline-block px-6 py-3 mt-6 font-bold leading-none text-white rounded shadow bg-brand-500">Læs mere</a>
				</div>
			</div>
	...
	<svg class="absolute bottom-0 w-full h-16 pointer-events-none fill-current md:h-64 text-brand-500" preserveAspectRatio="none" viewBox="0 0 100 100">
